"""Pipeline orchestrator — creates a workspace, runs steps through the
StepMachine, dispatches to executors, handles retries and recovery planning,
and finalises the run with version snapshots.
"""
