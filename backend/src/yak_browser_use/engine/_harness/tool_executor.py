...
async def _handle_eval_agent(
    ...
    from yak_browser_use.engine.eval_agent import EvalAgent
    from yak_browser_use.engine._harness.conversation_loop import Agent
...
def _append_eval_to_pipeline(
    ...
    import yaml
    from pathlib import Path
    from yak_browser_use.engine._harness.pipeline_tools import _resolve_pipeline_path
